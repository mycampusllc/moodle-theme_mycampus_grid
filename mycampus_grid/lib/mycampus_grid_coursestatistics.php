...
function mycampus_grid_coursestatistics($html)		{
	...
	for($i=0;$i<sizeof($rs_a);$i++)			{
		...
		if($专业名称!="")			{
			...
			print "<Tr class='TableData' align=center>
						...
						<td colspan=1 nowrap >".$mycampus_grid_GetCourseTeacherNumber_TEXT."</td>
						<td colspan=1 nowrap >".$mycampus_grid_GetCourseSectionNumber[$id]."</td>
						...
						<td colspan=1 nowrap >".$mycampus_grid_GetCourseEnrollmentStudentNumber[$id]."</td>
						<td colspan=1 nowrap >".$mycampus_grid_GetCourseQuizNumber[$id]."</td>
						<td colspan=1 nowrap >".mycampus_grid_GetCourseQuestionNumber($id,$fullname)."</td>
						<td colspan=1 nowrap >".$得到课程的assign数量[$id]."</td>
						<td colspan=1 nowrap >".$mycampus_grid_GetCourseOneMouthActivesNumber[$id]."</td>
