...
function mycampus_1_coursestatisticsALL($html)		{
	...
	$mycampus_1_GetCourseQuizNumber = array();
	...
	for($i=0;$i<sizeof($rsC_a);$i++)			{
		...
		$mycampus_1_GetCourseQuizNumber[$course] = $NUM;
	}

	$mycampus_1_GetCourseSectionNumber = array();
	...
	for($i=0;$i<sizeof($rsC_a);$i++)			{
		$NUM		= $rsC_a[$i]['NUM'];
		$course		= $rsC_a[$i]['course'];
		$mycampus_1_GetCourseSectionNumber[$course] = $NUM;
	}

	$mycampus_1_GetCourseEnrollmentStudentNumber = array();
	...
	for($i=0;$i<sizeof($rsC_a);$i++)			{
		$NUM		= $rsC_a[$i]['NUM'];
		$course		= $rsC_a[$i]['course'];
		$mycampus_1_GetCourseEnrollmentStudentNumber[$course] = $NUM;
	}
	...
	$mycampus_1_GetCourseOneMouthActivesNumber = array();
	...
	for($i=0;$i<sizeof($rsC_a);$i++)			{
		...
		$mycampus_1_GetCourseOneMouthActivesNumber[$course] = $NUM;
	}
	...
	for($i=0;$i<sizeof($rs_a);$i++)			{
		...
		if($专业名称!="")			{
			...
			print "<Tr class='TableData' align=center>
						...
						<td colspan=1 nowrap title='mycampus_1_GetCourseTeacherNumber_TEXT'>".$mycampus_1_GetCourseTeacherNumber_TEXT."</td>
						<td colspan=1 nowrap title='mycampus_1_GetCourseSectionNumber'>".$mycampus_1_GetCourseSectionNumber[$id]."</td>
						...
						<td colspan=1 nowrap title='mycampus_1_GetCourseEnrollmentStudentNumber'>".$mycampus_1_GetCourseEnrollmentStudentNumber[$id]."</td>
						<td colspan=1 nowrap title='mycampus_1_GetCourseQuizNumber'>".$mycampus_1_GetCourseQuizNumber[$id]."</td>
						<td colspan=1 nowrap title='mycampus_1_GetCourseQuestionNumber'>".mycampus_1_GetCourseQuestionNumber($id,$fullname)."</td>
						<td colspan=1 nowrap title='mycampus_1_GetCourseOneMouthActivesNumber'>".$mycampus_1_GetCourseOneMouthActivesNumber[$id]."</td>
